...
import { extractorPrimary, extractorFallback, analyst, categorizer, explorer } from "./agents/pricing";
...
export const mastra = new Mastra({
  agents: { extractorPrimary, extractorFallback, analyst, categorizer, explorer },
